...
path = "/Users/mehmettevfikkara/PycharmProjects/Miuul/resource/interproscan/*.tsv"
out_file = "/Users/mehmettevfikkara/PycharmProjects/Miuul/data/ipr_concat.csv"
...
for key, value in sp_dic.items():
    ...
    dic_ann[key]["sp"] = key
    dic_ann[key].to_csv(f"/Users/mehmettevfikkara/PycharmProjects/Miuul/data/{key}.csv", sep="\t", index=False)
